...
/*   Updated: 2025/08/25 21:39:47 by lluque           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	drip_conf_print_settings(t_drip_conf *drip_settings)
{
	...
	printf("\tWater timed on at: '%s'\n",
			drip_settings->wtod);
	printf("\t\tParsed:\n");
	drip_time_print_datetime(drip_settings->wtod_alarm);
	...
	{
		drip_time_print_datetime(*drip_settings->next_water_activation);
	...
	printf("\tLights timed on at: '%s'\n",
			drip_settings->ltod);
	printf("\t\tParsed:\n");
	drip_time_print_datetime(drip_settings->ltod_alarm);
	...
	{
		drip_time_print_datetime(*drip_settings->next_lights_activation);
